...
/**
 * An enum of scopes supported in Aladin Authentication.
 *
 * @property scope identifies the permission, same as in aladin.js
 */
enum class Scope(val scope: String) {
    ...
    companion object {
        /**
         * converts an array of scopes into a string usable by aladin.js
         */
        @JvmStatic
         ...
         *
         * @param scopeJSName name of scope as defined in aladin.js
         *
         */
        @JvmStatic
