...
import org.aladin.android.sdk.model.AladinConfig
 ...
 * Verified App Links is the recommended way for Android Aladin apps to handle the redirect after login.
 *
 * @param context an activity or the application context
 * @param config the aladin configuration used for this app
 */
class AppLinkVerifier(private val context: Context, private val config: AladinConfig) {

    /**
     * Verifies that digital asset links file of the Aladin configuration and the
    ...
    fun verify(): String? {
        try {
            ...
            if (msg != null) {
                Log.w(TAG, "Aladin apps should use Verified App Links. Read more at  https://developer.android.com/training/app-links/verify-site-associations\nThis warning can be suppressed by setting AladinSession.doNotVerifyAppLinkConfiguration = true.\n$msg")
            }
            return msg
        } catch (e: Exception) {
